    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-foreground">Code-128 Barcode Generator</h1>
          <p className="text-muted-foreground">Generate and manage professional barcodes</p>
        </div>
